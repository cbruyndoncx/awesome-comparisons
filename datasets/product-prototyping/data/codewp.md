...
### Frontend Stack
- PHP / WordPress
  - WordPress themes, plugins, and custom PHP templates.

### Backend Stack
- PHP / WordPress
  - WordPress + PHP backend; standard WordPress hosting.

### Database
- MySQL
  - WordPress standard MySQL/MariaDB database.


### Style Library
- None
  - PHP/WordPress output; no CSS framework generated by default.

### Testing
- None
  - Manual review in staging recommended; no automated test generation.
