...
### Languages
- Any
  - Primary support for Python, Java, TypeScript through LSP
...
- Multi-language support: Works with any language that has an LSP implementation.
...
- Wide integration: Works with Claude Code, Cursor, Cline, VSCode, ChatGPT (via mcpo), and others.
- Developer: Created by oraios with strong community adoption.
