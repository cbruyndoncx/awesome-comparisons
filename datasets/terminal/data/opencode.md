...
### Skills
- Yes
  - Extensible via custom actions/skills. Skills and actions act as specialized capabilities that can be added for domain-specific tasks and reused across sessions.
