...
function createClientMapping(mcpData) {
    ...
    const knownMappings = {
        ...
        'continue': 'continue-cli-client',
        'cline': 'Cline',
        'gemini-cli': 'gemini-cli-mcp-client',
        'github-copilot-cli': 'github-copilot-developer',
        'github-copilot': 'github-copilot-developer',
        'opencode': 'opencode',
        ...
        'claude-ai': 'claude-ai',
        'amazon-q-developer': 'Q-DEV-CLI',
        'amazon-q-developer-cli': 'Q-DEV-CLI',
        'roo-code': 'Roo-Code',
        'roocode': 'Roo-Code',
        'jetbrains-ai-assistant': 'JetBrains-IU-copilot-intellij',
        'visual-studio-code': 'Visual-Studio-Code',
        'vscode': 'Visual-Studio-Code',
        'chatgpt': 'ChatGPT',
        'jan-ai': 'Jan-Streamable-Client',
        'librechat': '@librechat/api-client',
        'raycast': 'com.raycast.macos',
        'dust': 'dust-mcp-client',
        'lobehub': 'lobehub-mcp-client',
        'mistral-le-chat': 'Mistral',
        'mistral-ai-le-chat': 'Mistral',
        'postman': 'Postman-Client',
        'arcade': 'arcade',
        'gitguardian': 'gitguardian',
        'make': 'make-app-mcp-client',
        'n8n': '@n8n/n8n-nodes-langchain.mcpClientTool',
        'amp': 'amp-mcp-client',
        'ampcode': 'amp-mcp-client',
        'codex-cli': 'codex-mcp-client',
        'warp': 'antigravity-client'
    };
