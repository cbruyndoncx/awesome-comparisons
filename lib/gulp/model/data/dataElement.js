...
class DataElement {
  constructor(name, url, shortDescription, criteriaData, averageRating, html, groupData, criteriaGroup, sourcePath, mcpEnrichment) {
    const ref = {
      name: name,
      url: url,
    ...
    this.editLink = null;
    this.mcpEnrichment = ref.mcpEnrichment || null;
  }
  ...
  json() {
    ...
    if (!isNullOrUndefined(this.mcpEnrichment)) {
      payload.mcpEnrichment = this.mcpEnrichment;
    }
    return payload;
  }
